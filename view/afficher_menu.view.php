      ...
      <ul>
        ...
        <?php if (isset($_SESSION['pseudo'])) { ?>
          <li class="bouton"><a href="#"><b>Guitares Electriques</b></a>
            <ul class="submenu2">
              <li class="bouton"><a href="../view/connexion.view.php"><b>Modèles Stratocaster</b></a></li>
              <li class="bouton"><a href="../view/inscription.view.php"><b>Modèles Telecaster</b></a></li>
          ...
          <li class="bouton"><a href="#"><b>Guitares Acoustiques</b></a></li>
          <li class="bouton"><a href="#"><b>Accessoires</b></a>
            <ul class="submenu4">
              <li class="bouton"><a href="../view/connexion.view.php"><b>Cordes</b></a></li>
              <li class="bouton"><a href="../view/inscription.view.php"><b>Câbles</b></a></li>
              <li class="bouton"><a href="../view/inscription.view.php"><b>Médiators</b></a></li>
            </ul>
          </li>
